    ...
    <>
      ...
      >
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 relative">
          ...
          <div className="flex items-center justify-center px-6 py-6 lg:py-0 lg:w-full mt-15 text-sm relative z-10">
            <div className="w-full max-w-md">
              ...
              <div className="space-y-3 mb-6 text-sm">
                ...
                >
                  ...
                  <span className="font-normal old text-gray-900">
                    Sign in with Google
                  </span>
                </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:border-gray-400 transition bg-white placeholder-gray-500 text-black"
                    required
                  />
                </div>
          ...
          {/* Right Side - Illustration Area (Full Height Overlay) */}
          <div
            className="hidden lg:flex items-center justify-center p-12 overflow-hidden fixed right-0 top-0 bottom-0 w-1/2 z-0"
            style={{
              background:
